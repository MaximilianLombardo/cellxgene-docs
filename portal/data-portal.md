...
![An example collection from the Teichmann group \(https://doi.org/10.1038/s41586-020-2797-4\)](../.gitbook/assets/image%20%285%29.png)
...
![Dataset entry in a collection page](../.gitbook/assets/image%20%282%29.png)
...
![Download dialog box](../.gitbook/assets/image%20%284%29.png)

Once you click on the download icon \( ![](../.gitbook/assets/image%20%283%29.png) \), a download dialog will appear. Each dataset that is hosted on the cellxgene data portal is available in the major single cell data formats \(namely AnnData and Seurat\). You can choose to either download these using the blue "Download" button or via the provided curl link.

### Explore

By clicking the cellxgene explorer icon \(![](../.gitbook/assets/image%20%286%29.png)\), an instance of the cellxgene hosted explorer will appear in appear in a new tab in your browser. Here is an example of what that will look like:
